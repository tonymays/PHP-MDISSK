...
/*
 * TPostgres
 * Child class for making and executing PostgreSQL connections and queries
 * @author Anthony Mays
 * @category Connection
 */
class TPostgres extends TPDO
{
	/*
	 * Class constructor
	...
	/*
	 * construct_dns
	 * construct a dns string to use with PostgreSQL connections
	 * @param None
	 * @return None
	 */
	final protected function construct_dns()
	{
		try
		{
			$this->dns = 'pgsql:dbname=' . $this->db_name . ';host=' . $this->host;
